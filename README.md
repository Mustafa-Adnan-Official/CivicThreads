...
You can select your specific city or ward out of the dropdown in teh top left corner. 

You can pan the heatmap by holding down right click and dragging, or using your scroll wheel to zoom in and out.

You can hover over thread boxes to see a short description in tooltip form, click to open the thread summary page.

The search bar present in the top right corner will find the thread of your choice on the heat map page, while searching in the Thread summary page navigates issues raised.
